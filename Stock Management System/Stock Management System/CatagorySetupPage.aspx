	...
	<form>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <div> 
					<asp:Button ID="catagorySaveButton" runat="server" class="btn btn-primary"  Text="Save" OnClick="catagorySaveButton_Click" /></div>
				<asp:Label ID="messageLabel" runat="server" ></asp:Label>
            </div>
        </div>
    </form>
    <asp:GridView ID="catagoryGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="Black" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
